...
public class GeneralPrinter<T> { // <T> present the scope of "T" inside the class
    ...
    public static void main(String[] args) {
        ...
        GeneralPrinter<Object> printer2 = new GeneralPrinter<>(new Book2("IJK"));
        ...
        GeneralPrinter<Object> printer3 = new GeneralPrinter<>(new Book2("ABC"));

        Object obj = new Book2("abc");
        if (obj instanceof Integer) { // safety concern
          Integer integer = (Integer) obj;
